...
class CommandBar_Commands {
	...
	private function build_commands(): array {
		return array(
			...
			array(
				'id'          => 'new-post',
				'title'       => __( 'New Post', 'commandbar' ),
				'description' => __( 'Create a new blog post', 'commandbar' ),
				'keywords'    => array( 'new post', 'create post', 'write', 'add post', 'blog' ),
				'icon'        => 'edit',
				'type'        => 'navigate',
				'url'         => admin_url( 'post-new.php' ),
				'capability'  => 'edit_posts',
				'group'       => __( 'Content', 'commandbar' ),
				'shortcut'    => '',
				'confirm'     => false,
			),
			array(
				'id'          => 'new-page',
				'title'       => __( 'New Page', 'commandbar' ),
				'description' => __( 'Create a new page', 'commandbar' ),
			...
			array(
				'id'          => 'new-media',
				'title'       => __( 'Upload Media', 'commandbar' ),
				'description' => __( 'Add images, videos or files to the media library', 'commandbar' ),
			...
			array(
				'id'          => 'all-posts',
				'title'       => __( 'All Posts', 'commandbar' ),
				'description' => __( 'View and manage all posts', 'commandbar' ),
			...
			array(
				'id'          => 'all-pages',
				'title'       => __( 'All Pages', 'commandbar' ),
				'description' => __( 'View and manage all pages', 'commandbar' ),
			...
			array(
				'id'          => 'media-library',
				'title'       => __( 'Media Library', 'commandbar' ),
				'description' => __( 'Browse all uploaded media files', 'commandbar' ),
			...
			array(
				'id'          => 'draft-posts',
				'title'       => __( 'Draft Posts', 'commandbar' ),
				'description' => __( 'View all draft posts', 'commandbar' ),
			...
			array(
				'id'          => 'scheduled-posts',
				'title'       => __( 'Scheduled Posts', 'commandbar' ),
				'description' => __( 'View posts scheduled for future publication', 'commandbar' ),
			...
			array(
				'id'          => 'comments',
				'title'       => __( 'Comments', 'commandbar' ),
				'description' => __( 'Manage and moderate comments', 'commandbar' ),
			...
			array(
				'id'          => 'themes',
				'title'       => __( 'Themes', 'commandbar' ),
				'description' => __( 'Browse and activate themes', 'commandbar' ),
				'keywords'    => array( 'themes', 'change theme', 'appearance', 'switch theme' ),
				'icon'        => 'admin-appearance',
				'type'        => 'navigate',
				'url'         => admin_url( 'themes.php' ),
				'capability'  => 'switch_themes',
				'group'       => __( 'Appearance', 'commandbar' ),
				'shortcut'    => '',
				'confirm'     => false,
			),
			array(
				'id'          => 'customize',
				'title'       => __( 'Customize', 'commandbar' ),
				'description' => __( 'Open the WordPress Customizer', 'commandbar' ),
			...
			array(
				'id'          => 'widgets',
				'title'       => __( 'Widgets', 'commandbar' ),
				'description' => __( 'Manage sidebar and footer widgets', 'commandbar' ),
			...
			array(
				'id'          => 'menus',
				'title'       => __( 'Menus', 'commandbar' ),
				'description' => __( 'Manage navigation menus', 'commandbar' ),
			...
			array(
				'id'          => 'site-editor',
				'title'       => __( 'Site Editor', 'commandbar' ),
				'description' => __( 'Open the Full Site Editor (FSE)', 'commandbar' ),
			...
			array(
				'id'          => 'all-plugins',
				'title'       => __( 'All Plugins', 'commandbar' ),
				'description' => __( 'View all installed plugins', 'commandbar' ),
			...
			array(
				'id'          => 'add-plugin',
				'title'       => __( 'Add Plugin', 'commandbar' ),
				'description' => __( 'Search and install new plugins from WordPress.org', 'commandbar' ),
			...
			array(
				'id'          => 'plugin-updates',
				'title'       => __( 'Plugin Updates', 'commandbar' ),
				'description' => __( 'View plugins that have available updates', 'commandbar' ),
			...
			array(
				'id'          => 'general-settings',
				'title'       => __( 'General Settings', 'commandbar' ),
				'description' => __( 'Site title, tagline, timezone and more', 'commandbar' ),
				'keywords'    => array( 'general settings', 'site title', 'tagline', 'admin email', 'timezone' ),
				'icon'        => 'admin-settings',
				'type'        => 'navigate',
				'url'         => admin_url( 'options-general.php' ),
				'capability'  => 'manage_options',
				'group'       => __( 'Settings', 'commandbar' ),
				'shortcut'    => '',
				'confirm'     => false,
			),
			array(
				'id'          => 'writing-settings',
				'title'       => __( 'Writing Settings', 'commandbar' ),
				'description' => __( 'Default post category, post format and editor settings', 'commandbar' ),
			...
			array(
				'id'          => 'reading-settings',
				'title'       => __( 'Reading Settings', 'commandbar' ),
				'description' => __( 'Homepage display, blog pages and feed settings', 'commandbar' ),
			...
			array(
				...
				'title'       => __( 'Discussion Settings', 'commandbar' ),
				'description' => __( 'Comment settings, moderation and notifications', 'commandbar' ),
			...
			array(
				'id'          => 'permalinks',
				'title'       => __( 'Permalinks', 'commandbar' ),
				'description' => __( 'URL structure and slug settings', 'commandbar' ),
			...
			array(
				'id'          => 'privacy-settings',
				'title'       => __( 'Privacy Settings', 'commandbar' ),
				'description' => __( 'Privacy policy page and GDPR settings', 'commandbar' ),
			...
			array(
				'id'          => 'all-users',
				'title'       => __( 'All Users', 'commandbar' ),
				'description' => __( 'View and manage all user accounts', 'commandbar' ),
			...
			array(
				'id'          => 'add-user',
				'title'       => __( 'Add New User', 'commandbar' ),
				'description' => __( 'Create a new user account', 'commandbar' ),
			...
			array(
				'id'          => 'your-profile',
				'title'       => __( 'Your Profile', 'commandbar' ),
				'description' => __( 'Edit your user profile and account settings', 'commandbar' ),
			...
			array(
				'id'          => 'import',
				'title'       => __( 'Import', 'commandbar' ),
				'description' => __( 'Import content from another platform or file', 'commandbar' ),
				'keywords'    => array( 'import', 'import content', 'migrate' ),
				'icon'        => 'download',
				'type'        => 'navigate',
				'url'         => admin_url( 'import.php' ),
				'capability'  => 'import',
				'group'       => __( 'Tools', 'commandbar' ),
				'shortcut'    => '',
				'confirm'     => false,
			),
			array(
				'id'          => 'export',
				'title'       => __( 'Export', 'commandbar' ),
				'description' => __( 'Export content as an XML file', 'commandbar' ),
			...
			array(
				'id'          => 'site-health',
				'title'       => __( 'Site Health', 'commandbar' ),
				'description' => __( 'Diagnose your site performance and security', 'commandbar' ),
			...
			array(
				'id'          => 'site-health-info',
				'title'       => __( 'Site Health Info', 'commandbar' ),
				'description' => __( 'Detailed system and server information', 'commandbar' ),
			...
			array(
				...
				'title'       => __( 'Erase Personal Data', 'commandbar' ),
				'description' => __( 'Remove personal data for a specific user (GDPR)', 'commandbar' ),
			...
			array(
				...
				'title'       => __( 'Flush Rewrite Rules', 'commandbar' ),
				'description' => __( 'Clear and regenerate all permalink rewrite rules', 'commandbar' ),
				...
				'capability'  => 'manage_options',
				'group'       => __( 'Actions', 'commandbar' ),
				'shortcut'    => '',
				'confirm'     => false,
			),
			array(
				'id'          => 'check-updates',
				'title'       => __( 'Check for Updates', 'commandbar' ),
				'description' => __( 'Visit the WordPress updates screen', 'commandbar' ),
			...
			array(
				'id'          => 'logout',
				'title'       => __( 'Log Out', 'commandbar' ),
				'description' => __( 'Sign out of your WordPress account', 'commandbar' ),
			...
			array(
				'id'          => 'dark-mode',
				'title'       => __( 'Toggle Dark Mode', 'commandbar' ),
				'description' => __( 'Switch between light and dark admin appearance', 'commandbar' ),
			...
			array(
				...
				'title'       => __( 'CommandBar Settings', 'commandbar' ),
				'description' => __( 'Configure the CommandBar command palette', 'commandbar' ),
